...
List<BlocProvider> blocProviders = [
  ...
  BlocProvider<AdminCategoryUpdateBloc>(
    create: (context) => AdminCategoryUpdateBloc(locator<CategoryUseCases>()),
  ),
  BlocProvider<AdminProductCreateBloc>(
    create: (context) => AdminProductCreateBloc(locator<ProductUseCases>()),
  ),
  ...
  BlocProvider<ClientProductDetailBloc>(
    create:
        (context) => ClientProductDetailBloc(locator<ShoppingBagUseCases>()),
  ),
  ...
  BlocProvider<ClientAddressCreateBloc>(
    create:
        (context) => ClientAddressCreateBloc(
  ...
  BlocProvider<ClientPaymentFormBloc>(
    create:
        (context) =>
            ClientPaymentFormBloc(locator<MercadoPagoUseCases>())
