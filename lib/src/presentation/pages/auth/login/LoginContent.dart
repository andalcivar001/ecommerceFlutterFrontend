...
class LoginContent extends StatelessWidget {
  ...
  LoginContent(this._loginBlocCubit);
      ...
      children: [
        Transform(
          ...
          child: Image.asset(
            ...
            width:
                MediaQuery.of(context).size.width, // para ocupar todo el ancho
            height:
                MediaQuery.of(context).size.height, // para ocupar todo el alto
            fit:
                BoxFit
        ...
        Container(
          ...
          child: Column(
            ...
            crossAxisAlignment:
                CrossAxisAlignment.center, // para centra de manera  horizontal
            children: [
