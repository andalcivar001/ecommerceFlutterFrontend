...
import 'package:ecommerce_flutter/src/presentation/pages/client/home/category/list/AdminCategoryListItem.dart';
...
class _ClientCategoryListPageState extends State<ClientCategoryListPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _bloc?.add(ClientCategoryListGetCategory());
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.pushNamed(context, 'Client/category/create');
        },
